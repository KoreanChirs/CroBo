...
from util.kinetics_mfmae import KineticsDataset

import models_crobo

from engine_crobo import train_one_epoch


def get_args_parser():
    parser = argparse.ArgumentParser("CroBo pre-training", add_help=False)
    ...
    # Model parameters
    parser.add_argument("--model", default="crobo_vit_small_patch16", type=str,
    ...
    parser.add_argument("--crobo_path", default="sm", type=str)
...
def main(args):
    ...
    model = models_crobo.__dict__[args.model](
        norm_pix_loss=args.norm_pix_loss,
        mask_ratio=args.mask_ratio,
        batch_size=args.batch_size,
        repeated_sampling=args.repeated_sampling,
        crobo_path=args.crobo_path,
    )
